...
var MobileHeader = /*#__PURE__*/function (_React$Component) {
  ...
  return _createClass(MobileHeader, [{
    ...
    key: "renderUserMenuToggle",
    value: function renderUserMenuToggle() {
    ...
    value: function render() {
      var _this$props3 = this.props,
        ...
        logoAltText = _this$props3.logoAltText,
        logoDestination = _this$props3.logoDestination,
        loggedIn = _this$props3.loggedIn,
        stickyOnMobile = _this$props3.stickyOnMobile,
        intl = _this$props3.intl,
        mainMenu = _this$props3.mainMenu,
        userMenu = _this$props3.userMenu,
        loggedOutItems = _this$props3.loggedOutItems;
      var logoProps = {
        src: logo,
        alt: logoAltText,
